...
(function($) { "use strict";
  ...
  var Renderer = function() {
    var aToolbarItem = {
      ...
      table:
        '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" tooltip="Table" flow="down" data-toggle="dropdown" tabindex="-1"><i class="icon-table"></i> <span class="caret"></span></button>' +
        ...
        '</ul>',
      style:
        '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" tooltip="Style" flow="down" title="" data-toggle="dropdown" tabindex="-1"><i class="icon-magic"></i> <span class="caret"></span></button>' +
        '<ul class="dropdown-menu">' +
        ...
        '</ul>',
      fontsize:
        '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" data-toggle="dropdown" tooltip="Font Size" flow="down"  tabindex="-1"><span class="note-current-fontsize">11</span> <b class="caret"></b></button>' +
        '<ul class="dropdown-menu">' +
        ...
        '</ul>',
      color:
        '<button type="button" class="btn btn-default btn-sm btn-small note-recent-color" tooltip="Recent Color" flow="down" title="" data-event="color" data-value=\'{"foreColor":"black","backColor":"yellow"}\' tabindex="-1"><i class="icon-font" style="color:black;background-color:yellow;"></i></button>' +
        '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" tooltip="More Color" flow="down" data-toggle="dropdown" tabindex="-1">' +
        ...
        '</ul>',
      bold:
        '<button type="button" class="btn btn-default btn-sm btn-small" tooltip="Bold Ctrl/Cmd + B" flow="down" title="" data-shortcut="" data-event="bold" tabindex="-1"><i class="icon-bold"></i></button>',
      italic:
        '<button type="button" class="btn btn-default btn-sm btn-small" tooltip="Italic Ctrl/Cmd + I" flow="down" data-shortcut="" data-event="italic" tabindex="-1"><i class="icon-italic"></i></button>',
      underline:
        '<button type="button" class="btn btn-default btn-sm btn-small" tooltip="Underline Ctrl/Cmd + U" flow="down" title="" data-shortcut="" data-event="underline" tabindex="-1"><i class="icon-underline"></i></button>',
      clear:
        '<button type="button" class="btn btn-default btn-sm btn-small" tooltip="{Remove Font Style Ctrl/Cmdd+ \\" flow="down"  data-shortcut="" data-event="removeFormat" tabindex="-1"><i class="icon-eraser"></i></button>',
      ul:
        '<button type="button" class="btn btn-default btn-sm btn-small" tooltip="Unordered list Ctrl/Cmd+Shift+8" flow="down" data-event="insertUnorderedList" tabindex="-1"><i class="icon-list-ul"></i></button>',
      ol:
        '<button type="button" class="btn btn-default btn-sm btn-small" tooltip="Ordered list Ctrl/Cmd+Shift+7" flow="down" data-event="insertOrderedList" tabindex="-1"><i class="icon-list-ol"></i></button>',
      paragraph:
        '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" tooltip="Alignment" flow="down" data-toggle="dropdown" tabindex="-1"><i class="icon-align-left"></i>  <span class="caret"></span></button>' +
        '<ul class="dropdown-menu">' +
          '<li>' +
    ...
    var createLayout = this.createLayout = function(welHolder, nHeight, nTabsize, aToolbarSetting) {
      ...
      //03. create Editable
      var welEditable = $('<div id="summernote" class="note-editable" contentEditable="true"></div>').prependTo(welEditor);
