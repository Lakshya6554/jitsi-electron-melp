...
(function(window, factory) {
  ...
  Tour = (function() {
    ...
    Tour.prototype.skip = function() {
      ...
      endHelper = (function(_this) {
        return function(e) {
          ...
          _this._force = false;
          _this._clearTimer();
          if (_this._options.onSkip != null) {
            return _this._options.onSkip(_this);
          }
        };
      })(this);
      promise = this.hideStep(this._current);
    ...
    Tour.prototype._initMouseNavigation = function() {
      ...
      })(this)).on("click.tour-" + this._options.name, ".popover.tour-" + this._options.name + " *[data-role='skip']", (function(_this) {
        return function(e) {
          e.preventDefault();
          return _this.skip();
        };
